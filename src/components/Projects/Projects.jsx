...
const Projects = ({ showProjectDetails }) => {
  let API =
    "https://script.google.com/macros/s/AKfycbwAFDc0owEsAC370IxjRSu92QX1ZPQs4MuTnlX0k3KQc7SMHTT8LHZzv1eopY5fkuG6/exec";
              ...
              >
                ...
                >
                  ...
                  <CardMedia
                    ...
                    height="200"
                    image={
                      project.image || "https://via.placeholder.com/345x140"
                    }
                    alt={`project.title`}
                  />
                  {/* ):(<div
